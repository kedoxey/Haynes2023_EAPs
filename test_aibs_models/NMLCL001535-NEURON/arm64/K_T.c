...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "gmax_K_T", "S/cm2",
 "conductance_K_T", "uS",
 "m_timeCourse_TIME_SCALE_K_T", "ms",
 "m_timeCourse_VOLT_SCALE_K_T", "mV",
 "m_steadyState_midpoint_K_T", "mV",
 "m_steadyState_scale_K_T", "mV",
 "m_q10Settings_experimentalTemp_K_T", "K",
 "m_q10Settings_TENDEGREES_K_T", "K",
 "h_timeCourse_TIME_SCALE_K_T", "ms",
 "h_timeCourse_VOLT_SCALE_K_T", "mV",
 "h_steadyState_midpoint_K_T", "mV",
 "h_steadyState_scale_K_T", "mV",
 "h_q10Settings_experimentalTemp_K_T", "K",
 "h_q10Settings_TENDEGREES_K_T", "K",
 "gion_K_T", "S/cm2",
 "m_timeCourse_t_K_T", "ms",
 "m_tauUnscaled_K_T", "ms",
 "m_tau_K_T", "ms",
 "h_timeCourse_t_K_T", "ms",
 "h_tauUnscaled_K_T", "ms",
 "h_tau_K_T", "ms",
 "g_K_T", "uS",
 0,0
};
...
"K_T",
 ...
 "conductance_K_T",
 "m_instances_K_T",
 "m_timeCourse_TIME_SCALE_K_T",
 "m_timeCourse_VOLT_SCALE_K_T",
 "m_steadyState_rate_K_T",
 "m_steadyState_midpoint_K_T",
 "m_steadyState_scale_K_T",
 "m_q10Settings_q10Factor_K_T",
 "m_q10Settings_experimentalTemp_K_T",
 "m_q10Settings_TENDEGREES_K_T",
 "h_instances_K_T",
 "h_timeCourse_TIME_SCALE_K_T",
 "h_timeCourse_VOLT_SCALE_K_T",
 "h_steadyState_rate_K_T",
 "h_steadyState_midpoint_K_T",
 "h_steadyState_scale_K_T",
 "h_q10Settings_q10Factor_K_T",
 "h_q10Settings_experimentalTemp_K_T",
 "h_q10Settings_TENDEGREES_K_T",
 0,
 "gion_K_T",
 "m_timeCourse_V_K_T",
 "m_timeCourse_t_K_T",
 "m_steadyState_x_K_T",
 "m_q10Settings_q10_K_T",
 "m_rateScale_K_T",
 "m_fcond_K_T",
 "m_inf_K_T",
 "m_tauUnscaled_K_T",
 ...
 "h_timeCourse_t_K_T",
 "h_steadyState_x_K_T",
 "h_q10Settings_q10_K_T",
 "h_rateScale_K_T",
 "h_fcond_K_T",
 "h_inf_K_T",
 "h_tauUnscaled_K_T",
 "h_tau_K_T",
 "conductanceScale_K_T",
 "fopen0_K_T",
 "fopen_K_T",
 "g_K_T",
 0,
...
static void nrn_alloc(Prop* _prop) {
	...
	double *_p; Datum *_ppvar;
 	...
 	m_steadyState_midpoint = -47;
 	m_steadyState_scale = 29;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 K_T /Users/katedoxey/Desktop/research/CRCNS/code/Haynes2023_EAPs/test_aibs_models/NMLCL001535-NEURON/K_T.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=K_T type=ionChannelHH)";
...
static int  rates ( _threadargsproto_ ) {
   ...
   m_timeCourse_t = ( 0.34 + 0.92 * ( exp ( - 1.0 * pow( ( ( m_timeCourse_V + 71.0 ) / 59.0 ) , 2.0 ) ) ) ) * m_timeCourse_TIME_SCALE ;
   ...
   h_timeCourse_t = ( 8.0 + 49.0 * ( exp ( - 1.0 * pow( ( ( h_timeCourse_V + 73.0 ) / 23.0 ) , 2.0 ) ) ) ) * h_timeCourse_TIME_SCALE ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/katedoxey/Desktop/research/CRCNS/code/Haynes2023_EAPs/test_aibs_models/NMLCL001535-NEURON/K_T.mod";
static const char* nmodl_file_text = 
