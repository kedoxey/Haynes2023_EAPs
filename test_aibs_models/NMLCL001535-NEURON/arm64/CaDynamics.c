...
#define rates rates__CaDynamics 
...
#define rate_concentration_columnindex 13
#define Dconcentration _p[14]
#define Dconcentration_columnindex 14
#define DextConcentration _p[15]
#define DextConcentration_columnindex 15
#define _g _p[16]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "rates_CaDynamics", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define iCa iCa_CaDynamics
 double iCa = 0;
#define initialExtConcentration initialExtConcentration_CaDynamics
 double initialExtConcentration = 0;
#define initialConcentration initialConcentration_CaDynamics
 double initialConcentration = 0;
#define surfaceArea surfaceArea_CaDynamics
 ...
 "surfaceArea_CaDynamics", "um2",
 "iCa_CaDynamics", "nA",
 "initialConcentration_CaDynamics", "mM",
 "initialExtConcentration_CaDynamics", "mM",
 "minCai_CaDynamics", "mM",
 "decay_CaDynamics", "ms",
 "depth_CaDynamics", "um",
 "Faraday_CaDynamics", "C",
 "AREA_SCALE_CaDynamics", "um2",
 "LENGTH_SCALE_CaDynamics", "um",
 "concentration_CaDynamics", "mM",
 "extConcentration_CaDynamics", "mM",
 "currDensCa_CaDynamics", "nA / um2",
 0,0
};
 ...
 "surfaceArea_CaDynamics", &surfaceArea_CaDynamics,
 "iCa_CaDynamics", &iCa_CaDynamics,
 "initialConcentration_CaDynamics", &initialConcentration_CaDynamics,
 "initialExtConcentration_CaDynamics", &initialExtConcentration_CaDynamics,
 0,0
};
...
"CaDynamics",
 ...
 "depth_CaDynamics",
 "Faraday_CaDynamics",
 "AREA_SCALE_CaDynamics",
 "LENGTH_SCALE_CaDynamics",
 0,
 "currDensCa_CaDynamics",
 0,
 "concentration_CaDynamics",
 "extConcentration_CaDynamics",
 0,
 0};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "area");
 	...
 	ivoc_help("help ?1 CaDynamics /Users/katedoxey/Desktop/research/CRCNS/code/Haynes2023_EAPs/test_aibs_models/NMLCL001535-NEURON/CaDynamics.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=CaDynamics type=concentrationModelHayEtAl)";
 ...
 v=_v;
{
  ...
  cai = _ion_cai;
 { error =  states();
 if(error){fprintf(stderr,"at line 97 in file CaDynamics.mod:\n    \n"); nrn_complain(_p); abort_run(error);}
 } {
   }
  _ion_cai = cai;
}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/katedoxey/Desktop/research/CRCNS/code/Haynes2023_EAPs/test_aibs_models/NMLCL001535-NEURON/CaDynamics.mod";
static const char* nmodl_file_text = 
