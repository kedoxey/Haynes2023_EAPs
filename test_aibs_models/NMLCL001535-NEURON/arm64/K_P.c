...
#define ek _p[46]
#define ek_columnindex 46
#define ik _p[47]
#define ik_columnindex 47
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "gmax_K_P", "S/cm2",
 "conductance_K_P", "uS",
 "m_timeCourse_TIME_SCALE_K_P", "ms",
 "m_timeCourse_VOLT_SCALE_K_P", "mV",
 "m_steadyState_midpoint_K_P", "mV",
 "m_steadyState_scale_K_P", "mV",
 "m_q10Settings_experimentalTemp_K_P", "K",
 "m_q10Settings_TENDEGREES_K_P", "K",
 "h_timeCourse_TIME_SCALE_K_P", "ms",
 "h_timeCourse_VOLT_SCALE_K_P", "mV",
 "h_steadyState_midpoint_K_P", "mV",
 "h_steadyState_scale_K_P", "mV",
 "h_q10Settings_experimentalTemp_K_P", "K",
 "h_q10Settings_TENDEGREES_K_P", "K",
 "gion_K_P", "S/cm2",
 "m_timeCourse_t_K_P", "ms",
 "m_tauUnscaled_K_P", "ms",
 "m_tau_K_P", "ms",
 "h_timeCourse_t_K_P", "ms",
 "h_tauUnscaled_K_P", "ms",
 "h_tau_K_P", "ms",
 "g_K_P", "uS",
 0,0
};
...
"K_P",
 ...
 "conductance_K_P",
 "m_instances_K_P",
 "m_timeCourse_TIME_SCALE_K_P",
 "m_timeCourse_VOLT_SCALE_K_P",
 "m_steadyState_rate_K_P",
 "m_steadyState_midpoint_K_P",
 "m_steadyState_scale_K_P",
 "m_q10Settings_q10Factor_K_P",
 "m_q10Settings_experimentalTemp_K_P",
 "m_q10Settings_TENDEGREES_K_P",
 "h_instances_K_P",
 "h_timeCourse_TIME_SCALE_K_P",
 "h_timeCourse_VOLT_SCALE_K_P",
 "h_steadyState_rate_K_P",
 "h_steadyState_midpoint_K_P",
 "h_steadyState_scale_K_P",
 "h_q10Settings_q10Factor_K_P",
 "h_q10Settings_experimentalTemp_K_P",
 "h_q10Settings_TENDEGREES_K_P",
 0,
 "gion_K_P",
 "m_timeCourse_V_K_P",
 "m_timeCourse_t_K_P",
 "m_steadyState_x_K_P",
 "m_q10Settings_q10_K_P",
 "m_rateScale_K_P",
 "m_fcond_K_P",
 "m_inf_K_P",
 "m_tauUnscaled_K_P",
 ...
 "h_timeCourse_t_K_P",
 "h_steadyState_x_K_P",
 "h_q10Settings_q10_K_P",
 "h_rateScale_K_P",
 "h_fcond_K_P",
 "h_inf_K_P",
 "h_tauUnscaled_K_P",
 "h_tau_K_P",
 "conductanceScale_K_P",
 "fopen0_K_P",
 "fopen_K_P",
 "g_K_P",
 0,
...
static void nrn_alloc(Prop* _prop) {
	...
	double *_p; Datum *_ppvar;
 	...
 	m_steadyState_midpoint = -14.3;
 	m_steadyState_scale = 14.6;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
...
#endif
  hoc_register_prop_size(_mechtype, 54, 3);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 K_P /Users/katedoxey/Desktop/research/CRCNS/code/Haynes2023_EAPs/test_aibs_models/NMLCL001535-NEURON/K_P.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=K_P type=ionChannelHH)";
...
static int  rates ( _threadargsproto_ ) {
   ...
   if ( m_timeCourse_V < ( - 50.0 ) ) {
     m_timeCourse_t = ( ( 1.25 + 175.03 * ( exp ( ( m_timeCourse_V ) * 0.026 ) ) ) ) * m_timeCourse_TIME_SCALE ;
     }
   else {
     m_timeCourse_t = ( ( 1.25 + 13.0 * ( exp ( ( m_timeCourse_V ) * - 0.026 ) ) ) ) * m_timeCourse_TIME_SCALE ;
     }
   ...
   h_timeCourse_t = ( 360.0 + ( 1010.0 + 24.0 * ( h_timeCourse_V + 55.0 ) ) * ( exp ( - 1.0 * ( ( h_timeCourse_V + 75.0 ) / 48.0 ) * ( ( h_timeCourse_V + 75.0 ) / 48.0 ) ) ) ) * h_timeCourse_TIME_SCALE ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/katedoxey/Desktop/research/CRCNS/code/Haynes2023_EAPs/test_aibs_models/NMLCL001535-NEURON/K_P.mod";
static const char* nmodl_file_text = 
